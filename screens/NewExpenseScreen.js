    ...
    const saveExpense = async () => {
        try {
            ...
            const expense = {
                ...
                title: title.trim() // You can set the title to the description for now, adjust as needed
            };
            console.log(expense)
    ...
    return (
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Add Amount</Text>
            </View>
            ...
            <View style={styles.expenseDetailContainer}>
                ...
                <View>
                    <Text style={{color: 'gray', fontSize: 18, fontWeight: '800', marginLeft: 30, marginBottom: 10}}>Description</Text>
                    <TextInput
                    style={styles.expenseText}
                    placeholder='Description writen here'
                    value={description}
